...
static const char col_gray2[]       = "#272935"; /* #444444; inactive window border colour */
static const char col_gray3[]       = "#BBBBBB"; /* #BBBBBB; font colour */
static const char col_gray4[]       = "#BBBBBB"; /* #EEEEEE; current tag and current window colour */
static const char col_cyan[]        = "#353840"; /* #005577; second bar colour and active window border colour */
